      ...
      <div className="footer">
        <div className="footer-content">
          ...
          <div className="footer-about">
            <h3><span>Anime</span><span className="about-blue">Madara</span></h3>
        ...
        <a href="https://github.com/madhvendra-singh/" target={"_blank"}><ion-icon name="logo-github" ></ion-icon></a>
        </div>
        </div>
      </div>
    </>
